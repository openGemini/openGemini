...
var messageMap = map[Errno]*Message{
	...
	FailToFillUpConnPool:     newWarnMessage("fail to fill up connection pool, err:%v", ModuleCastor),
	...
	FailToConnectToPyworker:  newFatalMessage("fail to connect to castor udf", ModuleCastor),
	...
	ResponseIncomplete:       newNoticeMessage("timeout, response imcomplete, want:%d, got:%d", ModuleCastor),
	...
	FieldNotFound:            newNoticeMessage("field info not found", ModuleCastor),
