...
type ContinuousQueryConfig struct {
	...
	RunInterval time.Duration `toml:"run-interval"`
...
const (
	...
	// DefaultMaxProcessCQNumber is the default max number of CQs to process in one run.
	DefaultMaxProcessCQNumber = 5
)
