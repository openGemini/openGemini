...
This code is originally from: https://github.com/prometheus/prometheus@v1.8.2/pkg/labels/labels.go
...
func (ls Labels) MarshalJSON() ([]byte, error) {
	sb := strings2.NewStringBuilder(8 * ls.Len())
	sb.AppendString("{")
	for _, l := range ls {
		sb.AppendString(strconv.Quote(l.Name))
		sb.AppendString(":")
		sb.AppendString(strconv.Quote(l.Value))
		sb.AppendString(",")
	}
	if ls.Len() > 0 {
