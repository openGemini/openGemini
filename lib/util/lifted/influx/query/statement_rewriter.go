...
This code is originally from: https://github.com/influxdata/influxdb/blob/1.7/query/statement_rewriter.go

2022.01.23 remove case *influxql.ShowSeriesStatement,*influxql.ShowSeriesCardinalityStatement etc. in func RewriteStatement
...
func rewriteShowTagValuesStatement(stmt *influxql.ShowTagValuesStatement) (influxql.Statement, error) {
	...
	return &influxql.ShowTagValuesStatement{
		...
		TagKeyCondition: rewriteSourcesCondition(stmt.Sources, expr),
		Condition:       stmt.Condition,
		SortFields:      stmt.SortFields,
		Limit:           stmt.Limit,
		Offset:          stmt.Offset,
...
func rewriteShowTagValuesCardinalityStatement(stmt *influxql.ShowTagValuesCardinalityStatement) (influxql.Statement, error) {
	...
	return &influxql.ShowTagValuesCardinalityStatement{
		Database:        stmt.Database,
		Sources:         stmt.Sources,
		Op:              stmt.Op,
		TagKeyExpr:      stmt.TagKeyExpr,
