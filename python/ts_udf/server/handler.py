...
from agent.openGemini_udf.agent import Handler
...
class CastorHandler(Handler, DataInterface):
    def __init__(self, data_dir, model_config_dir, version, meta_data, metric_handler):
        """Constructor"""
        ...
        self.udf_detector = UdfDetect(metric_handler)
    ...
    def _udf_detect(self, data_req: dict, cache, hook) -> List[pa.RecordBatch]:
        return self.udf_detector.detect(data_req)
