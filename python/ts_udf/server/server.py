...
from agent.openGemini_udf.agent import Server
...
def run(handler):
    ...
    model_store_dir = config["System"]["model_store_dir"]
    ...
    monitor_enabled = config["Monitor"]["monitor_enabled"] == "true"
    ...
    if path == "":
        bind_address = config["System"]["bind_address"]
    ...
    params = {
        ...
        "monitor_https_enabled": monitor_https_enabled,
