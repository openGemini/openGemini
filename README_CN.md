...
仓库内置了一套项目级 skills，统一放在 `.skill/skills/` 目录下，并以仓库内容为唯一事实来源。

- Claude Code 通过 `.claude/skills` 使用这些 skills
- OpenCode 通过 `.opencode/skills` 使用这些 skills
- Codex 通过 `~/.codex/skills` 下的符号链接使用这些 skills
...
更多说明请查看 `.skill/README.md`、`.skill/platforms.md` 和 `.skill/adding-skills.md`。
