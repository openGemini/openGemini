...
- **[WIP]** openTelemetry backend storage, simplified architecture
- Prometheus backend storage，support remote read/write
- **[WIP]** Support PromQL
- KubeEdge integration with openGemini, better manage edge device data

![image-20220927210909436](./images/cloud-native.png)
